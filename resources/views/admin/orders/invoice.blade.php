    ...
    <div class="container">
        <div class="no-print">
            ...
            <a href="{{ route('admin.orders.index') }}" class="btn btn-secondary">
                <i class="bi bi-arrow-right-circle-fill"></i> العودة للطلبات
            </a>
        </div>
        ...
        <div class="invoice-container">
            @php
                ...
                // إعادة حساب كل القيم لضمان الدقة
                $subtotal = 0;
            ...
            <header class="invoice-header row align-items-center mb-5">
                <div class="col-6 brand-logo">
                    <img src="https://cosmelea.com/storage/logo.png" alt="شعار Cosmelea">
                </div>
            ...
            <footer class="mt-5 text-center text-muted border-top pt-4">
                <p>شكرًا لثقتكم بنا في كوزميليا!</p>
